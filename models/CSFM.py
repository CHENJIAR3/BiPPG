# 源代码来自于https://github.com/guxiao0822/Cardiac-Sensing-FM
# 这里把channels
import numpy as np
import torch
...
class CSFM(nn.Module):
    ...
    def forward(self, ts, channel=None, text=None, mask=None, task='cls'):
        """
...
def CSFM_model(args,variant='tiny'):
    """
...
if __name__ == '__main__':
    ...
    model = CSFM_model(args,'tiny')

    x = torch.randn((1,4,1000))
    channels = np.asarray([12])  # ECG lead II + PPG
    print(model(x,channels).shape)
    # 3. 计算 FLOPs
